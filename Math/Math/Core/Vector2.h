...
namespace DeJong
{
	...
	typedef struct Vector2
	{
		...
		/* Initializes a new instance of a two dimentional vector from a predefined vector. */
		Vector2(_In_ const Vector2 &value)
			: X(value.X), Y(value.Y)
		{}
		...
		/* Creates a two dimentional unit vector from a specified angle in radians. */
		_Check_return_ static Vector2 Angle(_In_ float theta);
